// ======================================================================
// 00_Basic_Rx.v generated from TopDesign.cysch
// 08/22/2019 at 21:05
...
// DVDAC_v2_10(DAC_Range=0, Initial_Value=0, InternalClock=true, InternalClockFreqHz=250000, Resolution=12, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=DVDAC_v2_10, CY_CONFIG_TITLE=DVDAC, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=DVDAC, CY_INSTANCE_SHORT_NAME=DVDAC, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=10, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=DVDAC, )
module DVDAC_v2_10_3 (
	...
	cy_clock_v1_0
		#(.id("72b221bc-5561-4737-b73f-02e82487fd11/16079296-677d-4c97-a0f1-fd79fcfb8c33"),
	...
	cy_clock_v1_0
		#(.id("72b221bc-5561-4737-b73f-02e82487fd11/2b3078c1-9a14-4aea-bb80-3826ca4e0c90"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("4000000000"),
		  .is_direct(0),
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("f92fc657-7202-474a-b585-a34ba1cacedd"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("2a5616c9-253d-474b-96d2-2db9536e3b06"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
